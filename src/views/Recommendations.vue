<template>
  <div id="recommendations-view">
    <v-container>
      <v-layout row wrap>
        <v-flex xs12>
          <book-grid-list :title="$t('recommendations')" :cards="post.cards"/>
        </v-flex>
        <v-flex xs12>
          <div class="separate-line"></div>
        </v-flex>
        <v-flex xs12>
          <book-grid-list :title="$t('hello')" :cards="post.cards"/>
        </v-flex>
      </v-layout>
    </v-container>
  </div>
